...
public class CreateMomoRes {
    ...
    public CreateMomoRes(String parnerCode, String orderId, String requestId, long amount, long responseTime, String msg, int resultCode, String payUrl, String deeplink, String qrcodeUrl) {
